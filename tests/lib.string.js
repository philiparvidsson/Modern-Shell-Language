...
c = s.substr(2, 3)
d = s.substr(3, 4)
assert.equal(a.str(), 'h', 'substr failed 1')
assert.equal(b.str(), 'el', 'substr failed 2')
assert.equal(c.str(), 'llo', 'substr failed 3')
assert.equal(d.str(), 'lo w', 'substr failed 4')
