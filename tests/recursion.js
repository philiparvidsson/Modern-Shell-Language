...
assert.areEqual(fac(5), 120, 'recursion failed 5')

assert.areEqual(fib(0), 0 , 'recursion failed 6')
assert.areEqual(fib(1), 1 , 'recursion failed 7')
assert.areEqual(fib(2), 1 , 'recursion failed 8')
assert.areEqual(fib(3), 2 , 'recursion failed 9')
assert.areEqual(fib(4), 3 , 'recursion failed 10')
assert.areEqual(fib(5), 5 , 'recursion failed 11')
